...
$('.links-rapidos').css({ 'background-color': '#00000000', 'padding': '2px 10px', 'margin-top': '0px' } )
$('.links-rapidos').addClass('col-2'); $('.links-rapidos').removeClass('col-4')
menuTop.onclick = () => {
    if ($(menuTop).hasClass('abrir')) {
        $('.links-rapidos').css({ 'background-color': '#232427', 'padding': '10px 10px 5px 10px', 'margin-top': '-2px' } )
        ...
        $('.links-rapidos').addClass('col-2'); $('.links-rapidos').removeClass('col-4')
        $('.links-rapidos').css({ 'background-color': '#00000000', 'padding': '2px 10x', 'margin-top': '0px' } )
